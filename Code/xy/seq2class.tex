...
\begin{tikzpicture} [thick]
    ...
    \foreach \i in {2,4,...,16}
        {
            ...
            }
            {
                ...
                {
                    \node[rectangle,draw=Solarized-base01,fill=Solarized-base2,minimum height=0.6cm,minimum width=1.2cm] (y\index) at (\i,3) {$\hat{y}$};
                ...
                {
                    \node[rectangle,draw=Solarized-base01,minimum height=0.6cm,minimum width=1.2cm] (a\index) at (\i,1.5) {$\av_\subscript$};
                    \node[rectangle,draw=Solarized-base01,fill=Solarized-base2,minimum height=0.6cm,minimum width=1.2cm] (x\index) at (\i,0) {$\xv_\subscript$};
                }
    ...
    \node[rectangle,draw=Solarized-base01,minimum height=0.6cm,minimum width=1.2cm] (a) at (12,3) {$\av$};
