...
\begin{tikzpicture} [thick]
    ...
    \node[rectangle,draw=Solarized-base01,fill=Solarized-base2,minimum height=0.6cm,minimum width=1.2cm] (x5) at (10,0) {EOS};
    ...
    \foreach \i in {2,4,...,16}
        {
            ...
            \ifthenelse{\i < 10}
            {
                \ifthenelse{\i=6}
                {
                    \node[draw=none,minimum height=0.6cm,minimum width=1.2cm] (a\index) at (\i,1.5) {...};
                    \node[draw=none,minimum height=0.6cm,minimum width=1.2cm] (x\index) at (\i,0) {...};
                }
                {
                    \ifthenelse{\i=8}
                    {
                        \node[rectangle,draw=Solarized-base01,minimum height=0.6cm,minimum width=1.2cm] (a\index) at (\i,1.5) {$\av_T$};
                        \node[rectangle,draw=Solarized-base01,fill=Solarized-base2,minimum height=0.6cm,minimum width=1.2cm] (x\index) at (\i,0) {$\xv_T$};
                    }
                    {
                        \node[rectangle,draw=Solarized-base01,minimum height=0.6cm,minimum width=1.2cm] (a\index) at (\i,1.5) {$\av_\index$};
                        \node[rectangle,draw=Solarized-base01,fill=Solarized-base2,minimum height=0.6cm,minimum width=1.2cm] (x\index) at (\i,0) {$\xv_\index$};
                    }
                    \draw[->] (x\index) -- (a\index);
                }
            }
            {
                ...
                {
                    \node[draw=none,minimum height=0.6cm,minimum width=1.2cm] (a\index) at (\i,1.5) {...};
                    \node[draw=none,minimum height=0.6cm,minimum width=1.2cm] (y\index) at (\i,3) {...};
                }
                {
                    \ifthenelse{\i=16}
                    {
                        \node[rectangle,draw=Solarized-base01,minimum height=0.6cm,minimum width=1.2cm] (a\index) at (\i,1.5) {$\av_{T+S}$};
                        \node[rectangle,draw=Solarized-base01,fill=Solarized-base2,minimum height=0.6cm,minimum width=1.2cm] (y\index) at (\i,3) {$\yv_S$};
                    }
                    {
                        \node[rectangle,draw=Solarized-base01,minimum height=0.6cm,minimum width=1.2cm] (a\index) at (\i,1.5) {$\av_{T+\subscript}$};
                        \node[rectangle,draw=Solarized-base01,fill=Solarized-base2,minimum height=0.6cm,minimum width=1.2cm] (y\index) at (\i,3) {$\yv_\subscript$};
                    }
                    \draw[->] (a\index) -- (y\index);
                }
            }
            \ifthenelse{\i > 2}
            {
            ...
            {
                \pgfmathtruncatemacro{\im}{\index-1};
                \draw[->,dashed] (y\im) -- ++(0,0.8) -- ++(1,0) -- ++(0,-3.1) -- ++(1,0) -- (a\index);
            }{;}
        }
