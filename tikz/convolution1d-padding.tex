...
%\begin{align*}
%    \xymatrix{
%    *++[o][F-]{x_1} \ar@{.>}[ddr]|(.7){w_1} & *++[o][F-]{x_2} \ar@{.>}[dd]|(.65){w_2} \ar@{.>}[ddr]|(.7){w_1} & *++[o][F-]{x_3} \ar@{.>}[ddl]|(.7){w_3} \ar@{.>}[dd]|(.65){w_2} \ar@{.>}[ddr]|(.7){w_1} & *++[o][F-]{x_4} \ar@{.>}[ddl]|(.7){w_3} \ar@{.>}[dd]|(.65){w_2} \ar@{.>}[ddr]|(.7){w_1} & *++[o][F-]{x_5} \ar@{.>}[dd]|(.65){w_2} \ar@{.>}[ddl]|(.7){w_3} & *++[o][F-]{x_6} \ar@{.>}[ddl]|(.7){w_3} \\
%                                           &                                                                                                                                                                                                                                                                                                                                                            \\
%                                           & *++[o][F-]{a_1}                                                 & *++[o][F-]{a_2}                                                                         & *++[o][F-]{a_3}                                                                         & *++[o][F-]{a_4}
%    }
%\end{align*}
...
\begin{tikzpicture}
    \foreach \i in {1,...,5}
        {
            \node[circle,draw=Solarized-base01,minimum size=22] (x\i) at (2*\i,0) {$x_{\i}$};
        }

    \node[circle,draw=Solarized-base01,dashed,minimum size=22] (x0) at (0,0) {$0$};
    \node[circle,draw=Solarized-base01,dashed,minimum size=22] (x6) at (12,0) {$0$};
