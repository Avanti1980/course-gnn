...
\begin{tikzpicture} [thick]
    ...
    \node[rectangle,draw=Solarized-base01,fill=Solarized-base2,minimum height=0.6cm,minimum width=1.2cm] (o) at (0,3) {$\yv$};

    \node[rectangle,draw=Solarized-base01,minimum height=0.6cm,minimum width=1.2cm] (a) at (0,1.5) {$\av$};

    \node[rectangle,draw=Solarized-base01,fill=Solarized-base2,minimum height=0.6cm,minimum width=1.2cm] (i) at (0,0) {$\xv$};

    \draw[->] (i) -- (a);

    \draw[->] (a) -- (o);

    \path[-stealth] (a) edge[out=45,in=315,looseness=8] (a);
    ...
    \foreach \i in {3,5,...,13}
        {
            ...
            }
            {
                \ifthenelse{\i=13}
                {
                    \node[rectangle,draw=Solarized-base01,fill=Solarized-base2,minimum height=0.6cm,minimum width=1.2cm] (y\index) at (\i,3) {$\yv_T$};
                ...
                {
                    \node[rectangle,draw=Solarized-base01,fill=Solarized-base2,minimum height=0.6cm,minimum width=1.2cm] (y\index) at (\i,3) {$\yv_\index$};
