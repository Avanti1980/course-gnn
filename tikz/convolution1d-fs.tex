...
\begin{tikzpicture} [thick]
    ...
    \node[circle,draw=Solarized-base01,minimum size=22] (x1) at (0,0) {$x_1$};

    \node[circle,draw=Solarized-base01,dashed,minimum size=22] (x2) at (2,0) {$0$};
    \node[circle,draw=Solarized-base01,dashed,minimum size=22] (x3) at (4,0) {$0$};

    \node[circle,draw=Solarized-base01,minimum size=22] (x4) at (6,0) {$x_2$};

    \node[circle,draw=Solarized-base01,dashed,minimum size=22] (x5) at (8,0) {$0$};
    \node[circle,draw=Solarized-base01,dashed,minimum size=22] (x6) at (10,0) {$0$};

    \node[circle,draw=Solarized-base01,minimum size=22] (x7) at (12,0) {$x_3$};

    \node[circle,draw=Solarized-base01,minimum size=22] (a) at (6,2) {$a$};
    ...
    \foreach \i in {1,...,5}
        {
            \node[circle,draw=Solarized-base01,minimum size=22] (a\i) at (2*\i,-2) {$a_{\i}$};
        }
