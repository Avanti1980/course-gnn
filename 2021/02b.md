...
<!-- slide vertical=true data-notes="右下角为精度" -->

GNN-HEADER 监督学习 二分类示例

<img src="../python/binary-classif.svg" title="二分类示例" class="center top2 bottom0 width24">
...
<img src="../python/multi-classif-train-prediction.svg" title="数字识别数据" class="center top2 width30">

GNN-FOOTER 图神经网络导论 机器学习 tengzhang@hust.edu.cn

<!-- slide vertical=true data-notes="多分类就不止2类了 比如手写数字识别 就是10类了" -->
...
<img src="../python/clustering.svg" title="k均值聚类 4个簇 原数据生成用了6个簇" class="center top5 width25">
