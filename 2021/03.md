...
<img src="../tikz/srm.svg" class="width40 top-53per right8 lefta">
...
<img src="../python/surrogate-loss.svg" title="各种替代损失函数" class="right6 lefta top-51per width38">
...
- 全称<a target="_blank" href="https://en.wikipedia.org/wiki/Lasso_(statistics)">最小绝对收缩选择算子</a> (**l**east **a**bsolute **s**hrinkage and **s**election **o**perator, LASSO)
