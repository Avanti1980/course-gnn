...
<span class="blue">为什么将数据表示为图？</span>
...
@import "../dot/data-graph.dot" {class="top-6"}
...
<span class="blue">针对图数据有哪些学习任务？</span>
...
<span class="blue">为什么用神经网络来学习图数据？</span>
...
@import "../dot/grid-sequence.dot" {class="left10 top3 bottom1"}
...
- 图数据非结构化，点和点之间没有上、下、左、右、前、后的关系
- 什么神经网络结构可以捕捉图的拓扑结构信息
...
<span class="blue">图神经网络面临哪些方面的挑战？</span>
