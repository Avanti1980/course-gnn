    ...
    \foreach \i in {3,5,...,13}
        {
            ...
            }
            {
                \ifthenelse{\i=13}
                {
                    \node[rectangle,draw=Solarized-base01,fill=Solarized-base2,minimum height=0.6cm,minimum width=1.2cm] (y\index) at (\i,3) {$\hat{y}_T$};
                ...
                {
                    \node[rectangle,draw=Solarized-base01,fill=Solarized-base2,minimum height=0.6cm,minimum width=1.2cm] (y\index) at (\i,3) {$\hat{y}_\index$};
