...
\begin{tikzpicture} [thick]
    ...
    \node[draw=none,minimum size=32] (zlm1) at (-2.4,0) {};

    \node[circle,draw=Solarized-base01,minimum size=32] (alm1) at (0,0) {$\av_{l-1}$};

    \node[circle,draw=Solarized-base01,minimum size=32] (zl) at (3,0) {$\zv_l$};

    \node[circle,draw=Solarized-base01,minimum size=32] (al) at (5.4,0) {$\av_l$};

    \node[draw=none,minimum size=32] (zlp1) at (7.8,0) {};

    \node[above] at (1.5,0) {$\mathbf{W}_l, \bv_l$};
    \node[above] at (4.2,0) {$h_l$};
    ...
    \node[draw=none,minimum size=32] (zlm1rn) at (-2.4,-2) {};

    \node[circle,draw=Solarized-base01,minimum size=32] (alm1rn) at (0,-2) {$\av_{l-1}$};

    \node[circle,draw=Solarized-base01,minimum size=32] (t1) at (2.4,-2) {};

    \node[circle,draw=Solarized-base01,minimum size=32] (t2) at (4.2,-2) {};

    \node[diamond,draw=Solarized-base01,minimum size=32] (t3) at (6.6,-2) {$+$};

    \node[circle,draw=Solarized-base01,minimum size=32] (zlrn) at (8.4,-2) {$\zv_l$};

    \node[circle,draw=Solarized-base01,minimum size=32] (alp1) at (10.2,-2) {$\av_l$};

    \node[above] at (1.2,-2) {$\Uv_1, \cv_1$};
    \node[above] at (3.3,-2) {$h$};
    \node[above] at (5.4,-2) {$\Uv_2, \cv_2$};
    ...
    \draw[->] (alm1rn) to [out=330,in=210] (t3);
